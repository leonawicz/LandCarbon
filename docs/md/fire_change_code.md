...
# d.agg1 <- ddply(d, c('Scenario', 'Location', 'Vegetation', 'Year',
# 'Decade'), summarise, Avg=mean(Mean)) d.agg2 <- ddply(d2, c('Scenario',
# 'Location', 'Vegetation', 'Year', 'Decade'), summarise, Avg=mean(Mean))
